...
if TEST_ENV:
    print("Skipping the second pass due to test being true.", flush=True)
else:
    ...
    print(
        f"Finished processing all movies. Time taken: {elapsed_minutes} min and {elapsed_seconds} sec.",
        flush=True,
    )
